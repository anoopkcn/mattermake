...
# Define vocabulary
vocab = ['<START>','B', 'Zn', 'Er', 'P', 'N', 'Y', 'Bi', 'Ho', 'Ce', 'Te', 'Ca', '4',
         'Nb', 'Xe', 'Dy', 'C', 'Re', 'Tb', 'Tm', 'K', 'Ta', 'Tl', 'Al', '1',
         'O', 'Eu', 'H', 'Os', 'Cd', 'Hf', 'In', 'Na', 'Tc', 'Pb', '3', 'Sn',
         'Cs', '0', 'Ru', 'Mo', 'Fe', 'F', 'Zr', 'Br', 'Mn', 'Ag', 'I', 'Pd',
         'Cl', 'Ne', 'Hg', 'W', 'Sr', 'Kr', 'V', 'Si', 'Ge', 'La', 'o', '2',
         'Mg', 'Au', 'Rb', 'Se', '+', 'Li', 'Pm', 'Ar', 'Nd', 'S', 'Co', 'Lu',
         'Pr', 'Sc', 'Cu', 'Sb', 'Rh', 'He', '-', 'Pt', 'As', 'Sm', 'Gd', 'Be',
         'Ga', 'Ti', 'Ni', 'Ir', 'Cr', 'Ba', '<END>']
...
def encode_slice(slice_text):
    ...
    while i < len(slice_text):
        if i+1 < len(slice_text) and slice_text[i:i+2] in stoi:  # Try 2-char token
